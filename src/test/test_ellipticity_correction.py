...
def test_correction():
    ...
    calculated_correction = ellipticity_correction(arrivals, azimuth, source_latitude, model)
    
    for phase, expected, calculated in zip(phase_list, expected_correction, calculated_correction):
